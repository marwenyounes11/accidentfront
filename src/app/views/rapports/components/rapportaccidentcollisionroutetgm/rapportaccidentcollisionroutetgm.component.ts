...
@Component({
  selector: 'app-rapportaccidentcollisionroutetgm',
  templateUrl: './rapportaccidentcollisionroutetgm.component.html',
  styleUrls: ['./rapportaccidentcollisionroutetgm.component.css']
})
export class RapportAccidentCollisionRouteTgmComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.subscription= this.rapportAccidentCollisionRouteService.getAccidentTgms()
    .subscribe(data=>{
