...
@Component({
  selector: 'app-rapportaccidentcollisionroutemetros',
  templateUrl: './rapportaccidentcollisionroutemetros.component.html',
  styleUrls: ['./rapportaccidentcollisionroutemetros.component.css']
})
export class RapportAccidentCollisionRouteMetrosComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.subscription= this.rapportAccidentCollisionRouteService.getAccidentMetros()
    .subscribe(data=>{
this.accidents=data;
